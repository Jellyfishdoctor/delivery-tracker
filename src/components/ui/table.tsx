...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-xs font-medium text-slate-500 uppercase tracking-wider [&:has([role=checkbox])]:pr-0 border-b border-slate-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-4 py-3 align-middle text-slate-600 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
