...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t bg-slate-900 font-medium", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-xs font-medium text-slate-400 uppercase tracking-wider [&:has([role=checkbox])]:pr-0 border-b border-slate-800",
      className
    )}
    {...props}
  />
